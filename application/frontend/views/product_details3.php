...
<head>
	...
	<meta name="Keywords" content="Josie Maran Cosmetics, <?php echo $this->product[0]->title ?>" />
	<meta name="Description" content="<?php echo moss_truncate(strip_tags($this->product[0]->description), 128) ?>" />
    ...
    <meta property="og:description" content="<?php echo moss_truncate(strip_tags($this->product[0]->description), 128) ?>"/>
		...
		<div id="productinfo">
			...
			<div id="buybuttonswrapper">
					...
					<div class="socialbuttons">
						...
						<fb:like href="<?php echo str_replace("http://sandbox.", "http://www." , current_url());  ?>"
