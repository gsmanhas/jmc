    ...
    <body>
        ...
        <table width="98%" cellspacing="0" cellpadding="3" border="0">
            ...
            <tbody>
                    ...
                    <td colspan="2">
	                    ...
	                    <?php echo $this->Order[0]->bill_city ?>,&nbsp;<?php echo $bill_state ?>&nbsp;<?php echo $this->Order[0]->bill_zipcode ?><br /><br />
						 ...
						 <?php
						 		  ...
						 		  $ship_state = $this->Order[0]->destination_state;
						...
						<?php if ($this->Order[0]->shipping_same == 1) { ?>
		                    ...
		                    <?php echo $this->Order[0]->bill_city ?>,&nbsp;<?php echo $ship_state; ?>&nbsp;<?php echo $this->Order[0]->bill_zipcode ?><br /><br />
                ...
                <tr valign="top" style="background-color:#f3e4e9;">&trade;
                ...
                <tr valign="middle">
                    ...
                    <td colspan="3" align="left">
                        ...
                        <?php else :?>
                         ...
                         <span style="font-weight:normal;color:green;">-$<?php echo $this->cart->format_number($this->Order[0]->discount); ?>&nbsp;<?php //echo $FreeShipping ?></span>
                    ...
                    <td colspan="3" align="left">
					 ...
					 <?php 
					 	...
					 	if ($this->Order[0]->freeshipping != '' && $this->Order[0]->freeshipping != '0') { 
							...
							echo '<span style="font-weight:normal;color:green;">Free Shipping</span>';

						}else {

					 	 	echo '$'.$this->Order[0]->shipping_price;
