...
if ($this->Order[0]->promo_free_shipping == 1) {
            ...
            <tbody>
                ...
                <tr valign="top">
					...
					<td colspan="5">
						...
						<p>Hi <?php echo $this->Order[0]->firstname ?>,</p>

						<p>Your order has been shipped! Here is your tracking information:</p>

						<p style="color:#d02121;"><span>Tracking No.</span>&nbsp;<?php echo $this->track_number ?></p>

						<p>Shipped via <?php echo $this->Order[0]->shipping_name ?>.</p>
                ...
                <tr>
                    ...
                    <td colspan="2">
						...
						<?php if ($this->Order[0]->shipping_same == 1) { ?>
		                    ...
		                    <?php echo $this->Order[0]->bill_city ?>,&nbsp;<?php echo $this->Order[0]->destination_state ?>&nbsp;<?php echo $this->Order[0]->bill_zipcode ?><br /><br />
						...
						<?php } else { ?>
                            ...
                            <?php
                                ...
                                $query = $this->db->query('SELECT * FROM tax_codes where id = ?', $this->Order[0]->ship_state)->row();

                                if($query) {

                                    $ship_state = $query->tax_code;
                            ...
                            <?php echo $this->Order[0]->ship_city ?>,&nbsp;<?php echo $ship_state ?>&nbsp;<?php echo $this->Order[0]->ship_zipcode ?><br /><br />
                    ...
                    <td colspan="3">
	                    ...
	                    <!-- <span>Payment Type</span>&nbsp;<br /><?php if($this->Order[0]->payment_method == 1) { echo 'Credit Card'; }else if($this->Order[0]->payment_method == 4) { echo 'Test'; }else { echo 'PayPal'; } ?><br />	     -->
                ...
                ?>
                    ...
                    <tr valign="top" height="38px;">
                        ...
                        <td align="left">
							...
							<?php echo str_replace("GIFT ", "", $Product[0]->name); ?>

                        </td>

                        <td align="left"><?php if($item->qty > 0) { echo $item->qty; } else { echo 'Out of Stock'; } ?></td>
