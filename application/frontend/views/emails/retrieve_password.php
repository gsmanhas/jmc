    ...
    <body>
        ...
        <table width="98%" cellspacing="0" cellpadding="3" border="0">
            <tbody>
                ...
                <tr valign="top">
                    <td colspan="5">
	                    <p>Hi <?php echo $this->CUSTOMER_NAME ?>,</p>
	                    
	                    <p>You requested we email your password to you. Your username is <?php echo $this->USER_NAME ?> and your password is <?php echo $this->CUSTOMER_PASSWORD ?>. If this request did not come from you, please disregard this email. </p>
