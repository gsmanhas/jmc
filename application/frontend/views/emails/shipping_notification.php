            ...
            <tbody>
				...
				<tr>
					<td colspan="5">
						...
						<p style="color:#d02121;"><span>Tracking No.</span>&nbsp;<?php echo $this->TRACKING_NO ?></p>
						<p>Shipped via UPS.</p>
					</td>
				</tr>
				<tr>
                ...
                <tr valign="middle">
					...
					<td colspan="3" align="left">&#34;<?php echo $DiscountCode[0]->code ?>&#34;
                ...
                <tr valign="middle">
					...
					<td colspan="3" align="left"><?php if ($IS_FREE_SHIPPING2 != '' && $IS_FREE_SHIPPING2 != '0') { echo '<span style="font-weight:normal;color:green;">Free Shipping</span>'; }else { echo '$'.$ShippingOptions[0]['price']; } ?></td>
                </tr>
