...
<body id="message">
	...
	<div id="main">
		...
		<div id="messagewrapper">
			<h2>Thank you for signing up for the Josie Maran newsletter!</h2>
			<p>We have sent you a confirmation email. Please follow the instructions to complete the sign up process!</p>
		</div>
	</div>
