		...
		<div id="main-wrapper">
			<div id="main-content">
				<div class="page-title ui-widget-content ui-corner-all">
					<h1><b>Footer Menus</b></h1>
					<div class="other">
						<div class="float-left">Below is the list of your Footer Menus. Footer menus are navigational menus used throughout <br>your website. Please create a new Footer Menu or select an existing one to manage it.</div>
						<div class="button float-right">
							<a href="<?php echo base_url() ?>admin.php/footermenus/addnew" class="btn ui-state-default">
								<span class="ui-icon ui-icon-circle-plus"></span>Create a new Footer Menu
							</a>
