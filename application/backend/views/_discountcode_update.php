	...
	<div id="page-wrapper" class="fluid">
		<div id="main-wrapper">
			<div id="main-content">				
				...
				<div class="hastable">	
					<form id="frmMain" name="frmMain" method="post" action="<?php echo base_url() ?>admin/discountcode">
									...
									<table border="0" cellspacing="5" cellpadding="5">
										<tr>
											<th>
												...
												$q2 = $this->db->query("SELECT pid, cid FROM discountcode_rel_products WHERE d_id = " . $this->discountcode[0]->id);
										...
										<tr>
											<td>
												<select name="product_list[]" id="product_list" multiple size="29" style="width:100%; background:<?php echo $color; ?>" <?php echo $disabled ?>>
													...
													$queryA = $this->db->query("SELECT cid FROM discountcode_rel_catalogs WHERE d_id = " . $this->discountcode[0]->id);
													$Catalog_Ids = $queryA->result();
													
													$queryB = $this->db->query("SELECT pid, cid FROM discountcode_rel_products WHERE d_id = " . $this->discountcode[0]->id);
													...
													foreach ($Catalogs as $Catalog) {
														...
														foreach ($Catalog_Ids as $Cids) {
															if ($Cids->cid == $Catalog->id) {
