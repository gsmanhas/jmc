	...
	<div id="page-wrapper" class="fluid">
		<div id="main-wrapper">
			<div id="main-content">				
				<div class="page-title ui-widget-content ui-corner-all">
					...
					<div class="other">
						...
						<div class="button float-right">
							...
							<a href="<?php echo base_url() ?>admin/webpage" class="btn ui-state-default ui-corner-all">
				...
				<div class="hastable">	
					<form id="frmMain" name="frmMain" method="post" action="<?php echo base_url() ?>admin.php/argan-beauty/save">
