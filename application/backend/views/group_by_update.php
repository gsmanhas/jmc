	...
	<div id="page-wrapper" class="fluid">
		<div id="main-wrapper">
			<div id="main-content">				
				<div class="page-title ui-widget-content ui-corner-all">
					...
					<div class="other">
						...
						<div class="button float-right">
							...
							<a href="<?php echo base_url() ?>admin.php/groupby" class="btn ui-state-default ui-corner-all">
				...
				<div class="hastable">	
					<form id="frmMain" name="frmMain" method="post" action="<?php echo base_url() ?>admin.php/groupby">
					...
					<thead>
						<tr>
							...
							<!--
							<td>Product Title</td>
							<td><?php echo $this->Product[0]->title ?></td>
							-->
						</tr>
					</thead>
					<tbody>
						<tr>
							<td>
								<select name="product_group_by[]" id="product_group_by" multiple="true" size="40" style="width:100%">
								<?php
								$query = $this->db->query(
								...
								$query = $this->db->query(
									"SELECT with_id FROM product_group_by WHERE pid = " . $this->Product[0]->id
								);
								...
								for ($i = 0; $i < count($Products); $i++) {
									...
									printf('<option value="%s" %s>%s</option>', $Products[$i]['id'], $Checked, $Products[$i]['name']);
								}							
								?>
								</select>
							</td>
