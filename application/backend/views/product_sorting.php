...
<script type="text/javascript" charset="utf-8">
	function goSorting (ndx) {
		document.getElementById('id').value = ndx;
			...
			<div id="main-content">
				...
				<div class="hastable">					
					...
					<table>
						...
						<tr>
							<td><?php echo $i; ?></td>
							<td><a href="javascript:goSorting(<?php echo $catalog->id ?>)"><?php echo $catalog->name ?></a></td>
						</tr>
						<?php
							$i++;
						}
					...
					<input type="hidden" name="action" value="sorting" id="action">
