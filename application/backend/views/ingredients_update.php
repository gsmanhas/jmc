...
jQuery(document).ready(function(){
	jQuery("#btn_submit").click(function(){
		if (jQuery("#ingredients_image").val() == "Click here to browse the server") {
			jQuery("#ingredients_image").val('');
		}
		...
		<div id="main-wrapper">
			<div id="main-content">				
				...
				<table>
					<tr>
						<td>	
							<form id="frmMain" name="frmMain" method="post" action="<?php echo base_url() ?>admin.php/ingredients">
							<table border="0" cellspacing="5" cellpadding="5" id="inner">
								<tr>
									<td><div class="fieldlabel" style="padding-bottom:3px;">Publish</div>
										<span>
											<input type="radio" name="publish" class="field checkbox" value="1" <?php echo ($this->ingredients[0]->publish == 1) ? 'checked="checked"' : "" ?> >
											<label class="choice">Yes</label>
										</span>	
										<span>
											<input type="radio" name="publish" class="field checkbox" value="0" <?php echo ($this->ingredients[0]->publish == 0) ? 'checked="checked"' : "" ?> >
								...
								<tr>
									<td><div class="fieldlabel" style="padding-bottom:3px;">Image</div>
										<input style="width:50%" id="symbolkey_image" name="image" type="text" readonly="readonly" value="<?php echo ($this->ingredients[0]->image == "") ? "Click here to browse the server" : $this->ingredients[0]->image; ?>" onclick="openKCFinder(this)" style="width:600px;cursor:pointer" /><br />
								...
								<tr>
									<td><div class="fieldlabel" style="padding-bottom:3px;">Title</div>
										<div>
											<input style="width:50%" type="text" name="title" class="field text small" value="<?php echo $this->ingredients[0]->title ?>" maxlength="255" tabindex="1">
										</div>
									</td>
								</tr>
								<tr>
									<td><div class="fieldlabel" style="padding-bottom:3px;">Description</div>
										<textarea class="ckeditor" name="description" cols="20" rows="20"><?php echo $this->ingredients[0]->description ?></textarea>
									</td>
								</tr>
							</table>

							<input type="hidden" name="action" value="update_save" id="action">
							<input type="hidden" name="id" value="<?php echo $this->ingredients[0]->id ?>" id="id">
