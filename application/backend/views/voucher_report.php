		...
		<div id="main-wrapper">
			<div id="main-content">
				...
				<table>
					<tr>
						<td>					
							<form id="frmMain" name="frmMain" method="post" action="<?php echo base_url() ?>admin.php/voucherreport/search">
							
							<ul>
								<li>
									<label class="desc">From Order Date</label>
									<input type="text" name="from_date" value="" id="release_date" style="width:50%;">
								</li>
								<li>
									<label class="desc">To Order Date</label>
									<input type="text" name="to_date" value="" id="expiry_date" style="width:50%;">
								</li>
							</ul>
