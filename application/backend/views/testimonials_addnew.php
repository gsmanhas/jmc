		...
		<div id="main-wrapper">
			<div id="main-content">				
				...
				<table>
					<tr>
						<td>
							<form id="frmMain" name="frmMain" method="post" action="<?php echo base_url() ?>admin.php/testimonials/save">
								...
								<table border="0" cellspacing="5" cellpadding="5" id="inner">
									...
									<tr>
										<td><div class="fieldlabel" style="padding-bottom:3px;">Customer Quote</div>
											<div>
												<input style="width:50%" type="text" name="customer_name" class="field text small" value="<?php echo set_value('customer_name'); ?>" maxlength="255" tabindex="1">
											</div>
										</td>
									</tr>
									<tr>
										<td><div class="fieldlabel" style="padding-bottom:3px;">Details</div>
											<textarea class="ckeditor" name="quote" cols="20" rows="20"><?php echo set_value('quote'); ?></textarea>
										</td>
									</tr>
								</table>
