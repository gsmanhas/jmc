		...
		<div id="main-wrapper">
			<div id="main-content">
				<div class="page-title ui-widget-content ui-corner-all">
					<h1><b>Catalogs</b></h1>
					<div class="other">
						<div class="float-left">Below is the list of your catalogs. Catalogs are part of your online shop and consist of the <br>products that you sell. Select a catalog to edit its details and assign products to it!</div>
						<div class="button float-right">
							<a href="<?php echo base_url() ?>admin.php/catalogs/addnew" class="btn ui-state-default">
								<span class="ui-icon ui-icon-circle-plus"></span>Create a new Catalog
							</a>
				...
				<div class="hastable">					
					...
					<table>
						...
						<tr>
							...
							<td>
								<input style="width:100%;" type="text" name="order[]" value="<?php echo $catalog->ordering ?>" size="6">
							</td>
							<td>
