	...
	<div id="page-wrapper" class="fluid">
		<div id="main-wrapper">
			<div id="main-content">				
				...
				<div class="hastable">	
					<form id="frmMain" name="frmMain" method="post" action="<?php echo base_url() ?>admin.php/about_the_brand/save">
						...
						<table border="0" cellspacing="5" cellpadding="5">
							...
							<tr>
								...
								<td class="fieldlabel">Page URL</td>
