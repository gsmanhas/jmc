		...
		<div id="main-wrapper">
			<div id="main-content">				
				...
				<table>
					<tr>
						<td>
							<form id="frmMain" name="frmMain" method="post" action="<?php echo base_url() ?>admin.php/symbolkey/save">
							<ul>
								<li>
								...
								<li>
									...
									<input style="width:50%" id="large_image" name="large_image" type="text" readonly="readonly" value="<?php echo (set_value('image') == "") ? "Click here to browse the server" : set_value('large_image'); ?>" onclick="openKCFinder(this)" style="width:600px;cursor:pointer" /><br />
								</li>
								<li>
								...
								<li>
									...
									<div>							
										<textarea style="width:50%;font-family:Arial,Verdan,Sans-Serif;font-size:12px;line-height:1.25em;" name="description" class="field textarea small" rows="5" cols="50"><?php echo set_value('description'); ?></textarea>
									</div>
								</li>
							</ul>
