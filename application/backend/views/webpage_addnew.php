		...
		<div id="main-wrapper">
			<div id="main-content">				
				<div class="page-title ui-widget-content ui-corner-all">
					<h1><b>Create a new Web Page</b></h1>
					<div class="other">
				...
				<div class="hastable">	
					<form id="frmMain" name="frmMain" method="post" action="<?php echo base_url() ?>admin.php/webpage/save">
						...
						<table border="0" cellspacing="5" cellpadding="5">
							...
							<tr>
								...
								<td><input type="text" name="page_name" value="<?php echo set_value('page_name'); ?>" id="page_name" style="width:100%"></td>
								<td width="12%" class="fieldlabel">Page URL</td>
								<td><input type="text" name="page_url" value="<?php echo set_value('page_url'); ?>" id="page_url" style="width:100%"></td>
							</tr>
							<tr>
								<td class="fieldlabel">Page Title</td>
								<td><input type="text" name="page_title" value="<?php echo set_value('page_title'); ?>" id="page_title" style="width:100%"></td>
								<td class="fieldlabel">Author</td>
								<td><input type="text" name="author" value="<?php echo set_value('author'); ?>" id="author" style="width:100%"></td>
							</tr>
							<tr>
								<td class="fieldlabel">Meta Description</td>
								<td colspan="3">
									<input type="text" name="meta_description" value="<?php echo set_value('meta_description'); ?>" id="meta_description" style="width:100%">
								</td>								
							</tr>
							<tr>
								<td class="fieldlabel">Meta Keywords</td>
								<td colspan="3">
									<input type="text" name="meta_keyword" value="<?php echo set_value('meta_keyword'); ?>" id="meta_keyword" style="width:100%">
								</td>								
							</tr>
							<tr>
								<td class="fieldlabel">Robots</td>
								<td colspan="3">
									<input type="text" name="meta_robots" value="<?php echo set_value('meta_robots'); ?>" id="meta_robots" style="width:100%">
								</td>								
							</tr>
							...
							<tr>
								...
								<div class="fieldlabel"><br>Content<br><br></div>
									<textarea class="ckeditor" cols="80" id="page_content" name="page_content" rows="20"><?php echo set_value('page_content'); ?></textarea>
								</td>
							</tr>
						</table>
