		...
		<div id="main-wrapper">
			<div id="main-content">				
				...
				<table>
					<tr>
						<td>
							<form id="frmMain" name="frmMain" method="post" action="<?php echo base_url() ?>admin.php/store_locator">
							<ul>
								<!-- <li>
								...
								<li>		
									...
									<div>
									<input style="width:50%" type="text" name="name" value="<?php echo $this->markers[0]->name ?>" maxlength="255" tabindex="1">
									</div>
								</li>
								<li>
									<label class="desc">Address</label>
									<div>
									<input style="width:50%" type="text" name="address" value="<?php echo $this->markers[0]->address ?>" maxlength="255" tabindex="2">
									</div>
								</li>
								<li>
									<label class="desc">Phone</label>
									<div>
									<input style="width:50%" type="text" name="phone" value="<?php echo $this->markers[0]->phone ?>" maxlength="255" tabindex="2">
									</div>
								</li>
								<li>
									<label class="desc">lat</label>
									<div>
									<input style="width:50%" type="text" name="lat" value="<?php echo $this->markers[0]->lat ?>" maxlength="255" tabindex="2">
									</div>
								</li>
								<li>
									<label class="desc">lng</label>
									<div>
									<input style="width:50%" type="text" name="lng" value="<?php echo $this->markers[0]->lng ?>" maxlength="255" tabindex="2">
									</div>
								</li>
							</ul>
								
								<input type="hidden" name="action" value="update_save" id="action">
								<input type="hidden" name="id" value="<?php echo $this->markers[0]->id ?>" id="id">
