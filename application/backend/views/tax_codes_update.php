...
<script type="text/javascript" charset="utf-8">
	...
	jQuery(document).ready(function(){
		...
		jQuery("#dialog_link").click(function(){
			location.href = '<?php echo base_url() ?>admin.php/taxcodes';
		});
		...
		<div id="main-wrapper">
			<div id="main-content">				
				<div class="page-title ui-widget-content ui-corner-all">
					<h1><b>Edit an existing Tax Code</b></h1>
					<div class="other">
				...
				<table>
					<tr>
						<td>	
							<form id="frmMain" name="frmMain" method="post" action="<?php echo base_url() ?>admin.php/taxcodes">
							...
							<ul>
									<li>
										...
										<?php
											...
											foreach ($states as $state) {
												$is_select = "";
												if ($state->id == $this->TaxRate[0]->state_id) {
									...
									<li>
										...
										<input type="text" name="tax_code" value="<?php echo $this->TaxRate[0]->tax_code ?>" id="tax_code" style="width:50%">
									</li>
									<li>
										<label class="desc">Tax Rate %</label>
										<input type="text" name="tax_rate" value="<?php echo $this->TaxRate[0]->tax_rate ?>" id="tax_rate" style="width:50%">
									</li>
								</ul>
												
										<input type="hidden" name="action" value="update_save" id="action">
										<input type="hidden" name="id" value="<?php echo $this->TaxRate[0]->id ?>" id="id">
