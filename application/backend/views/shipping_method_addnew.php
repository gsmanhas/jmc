		...
		<div id="main-wrapper">
			<div id="main-content">				
				<div class="page-title ui-widget-content ui-corner-all">
					<h1><b>Create a new Shipping Option</b></h1>
					<div class="other">
				...
				<table>
					<tr>
						<td>	
							<form id="frmMain" name="frmMain" method="post" action="<?php echo base_url() ?>admin.php/shipping/save">
								
								<ul>
									<li>
										<label class="desc">Name</label>
										<input type="text" name="name" value="<?php echo set_value('name') ?>" id="name" style="width:50%">
									</li>
									<li>
										<label class="desc">Price</label>
										<input type="text" name="price" value="<?php echo set_value('price') ?>" id="price" style="width:50%">
									</li>
									<li>
										<label class="desc">Estimate Delivery Time (Ex. 7-10 Business Days)</label>
										<input type="text" name="estDelivery" value="<?php echo set_value('estDelivery'); ?>" id="estDelivery" style="width:50%">
									</li>
								</ul>
