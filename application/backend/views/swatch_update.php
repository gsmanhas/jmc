		...
		<div id="main-wrapper">
			<div id="main-content">				
				<div class="page-title ui-widget-content ui-corner-all">
					<h1><b>Edit an existing Swatch</b></h1>
					<div class="other">
						...
						<td>	
							...
							<ul>
								<li>
									...
									<div class="col">
										<span>
											<input type="radio" name="publish" class="field checkbox" value="1" <?php echo ($this->swatch[0]->publish == 1) ? 'checked="checked"' : "" ?> >
											<label class="choice">Yes</label>
										</span>	
										<span>
											<input type="radio" name="publish" class="field checkbox" value="0" <?php echo ($this->swatch[0]->publish == 0) ? 'checked="checked"' : "" ?> >
								...
								<li>
									...
									<input style="width:50%" id="swatch[0]_image" name="image" type="text" readonly="readonly" value="<?php echo ($this->swatch[0]->image == "") ? "Click here to browse the server" : $this->swatch[0]->image; ?>" onclick="openKCFinder(this)" style="width:600px;cursor:pointer" /><br />
									<div id="kcfinder_div"></div>
								</li>					
								<li>
									<label class="desc">Title</label>
									<div>
										<input style="width:50%" type="text" name="title" class="field text small" value="<?php echo $this->swatch[0]->title ?>" maxlength="255" tabindex="1">
									</div>
								</li>
							</ul>
							
							<input type="hidden" name="action" value="update_save" id="action">
							<input type="hidden" name="id" value="<?php echo $this->swatch[0]->id ?>" id="id">
