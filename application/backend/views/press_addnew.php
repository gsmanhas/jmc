		...
		<div id="main-wrapper">
			<div id="main-content">				
				...
				<table>
					<tr>
						<td>
							<form id="frmMain" name="frmMain" method="post" action="<?php echo base_url() ?>admin.php/press/save">
								...
								<table border="0" cellspacing="5" cellpadding="5" id="inner">
									...
									<tr>
										<td><div class="fieldlabel" style="padding-bottom:3px;">Cover</div>
											<input style="width:50%" id="cover" name="cover" type="text" readonly="readonly" value="<?php echo (set_value('cover') == "") ? "Click here to browse the server" : set_value('cover'); ?>" onclick="openKCFinder(this)" style="width:600px;cursor:pointer" /><br />
											<div id="kcfinder_div"></div>
										</td>
									</tr>
									<tr>
										<td><div class="fieldlabel" style="padding-bottom:3px;">Clip</div>
											<input style="width:50%" id="clip" name="clip" type="text" readonly="readonly" value="<?php echo (set_value('clip') == "") ? "Click here to browse the server" : set_value('clip'); ?>" onclick="openKCFinder(this)" style="width:600px;cursor:pointer" /><br />
											<div id="kcfinder_div"></div>
										</td>
									</tr>
									<tr>
