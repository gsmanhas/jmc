				...
				<div class="page-title ui-widget-content ui-corner-all">
					...
					<div class="other">
						...
						<div class="button float-right">
							...
							<a href="<?php echo base_url() ?>admin.php/footer/text" class="btn ui-state-default">

								<span class="ui-icon ui-icon-circle-plus"></span>Manage Footer Text

							</a>

							<a href="<?php echo base_url() ?>admin.php/footer/addnew" class="btn ui-state-default">

								<span class="ui-icon ui-icon-circle-plus"></span>Create a new Footer Link
					...
					<form id="frmMain" name="frmMain" method="post" action="">
						...
						<table >
							...
							<tbody>
								...
								foreach ($this->FooterLinks as $MenuItem) {
								...
								<tr>
                                    ...
                                    <td><?php echo $this->Section[$MenuItem->section_id-1]->name; ?></td>

									<td><?php echo $MenuItem->position ?></td>

									<td>

										<?php /*?><?php if ($MenuItem->is_active == 'Y') { ?>

											<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" href="javascript:publish(<?php echo $MenuItem->id ?>, N)">
										...
										<?php } else { ?>
											...
											<a class="btn_no_text btn ui-state-default ui-corner-all tooltip" href="javascript:publish(<?php echo $MenuItem->id ?>, Y)">
