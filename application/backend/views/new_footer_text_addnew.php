		...
		<div id="main-wrapper">
			...
			<div id="main-content">				
				...
				<div class="page-title ui-widget-content ui-corner-all">
					...
					<h1><b>Create a new Footer Text</b></h1>
				...
				<table>
					...
					<tr>
						...
						<td>	
							...
							<form id="frmMain" name="frmMain" method="post" action="<?php echo base_url() ?>admin.php/footer/saveText">
								...
								<ul>
                                    ...
                                    <li>
										...
										<textarea name="text" id="text" style="width:50%" ><?php echo set_value('text'); ?></textarea>
