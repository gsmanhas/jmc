...
* 
*/
class giving_back extends CI_Controller
{	
	...
	public function index()
	{
		...
		$query = $this->db->query("SELECT * FROM special_page WHERE id = 2");
	...
	{		
		...
		if ($this->db->trans_status() === FALSE) {
			...
			log_message('error', 'giving_back->save() 交易錯誤');
		}
		
		// redirect('/admin/webpage/success', 'refresh');
		$this->index();
	}
