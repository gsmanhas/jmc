$(document).ready(function() { 
	...
	// console.log(jQuery("ul#navigation"));
...
*/
    ...
    $(function() {
		...
		//	修改加入了 Style with jQuery Flick UI
		// $("link[title='style']").attr("href","/systemcart/css/styles/flick/ui.css");
		
		$("link[title='style']").attr("href","/css/styles/flick/ui.css");
