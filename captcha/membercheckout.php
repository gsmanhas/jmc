		...
		<div class="accountinputbox">
            ...
            <fieldset id="shipping_information" <?php echo $style?>>
				...
				<p>
					...
					<input type="text" value="<?php echo $this->session->userdata('ship_first_name') ?>" id="ship_first_name" name="ship_first_name" class="inputtext" maxlength="100">
				</p>
				<p>
					<label for="ship_last_name">Recipient Last Name*<?php echo form_error('ship_last_name', '<span class="error">&nbsp;&nbsp;', '</span>'); ?></label><br>
					<input type="text" value="<?php echo $this->session->userdata('ship_last_name') ?>" id="ship_last_name" name="ship_last_name" class="inputtext" maxlength="100">
				</p>
				<p>
					<label for="ship_address">Address*<?php echo form_error('ship_address', '<span class="error">&nbsp;&nbsp;', '</span>'); ?></label><br>
					<input type="text" value="<?php echo $this->session->userdata('ship_address') ?>" id="ship_address" name="ship_address" class="inputtext">
				</p>				
				<p>
					<input type="text" value="<?php echo $this->session->userdata('ship_address2') ?>" id="ship_address2" name="ship_address2" class="inputtext">
				</p>
				
				<p style="width:206px;float:left;">
					<label for="ship_city">City*<?php echo form_error('ship_city', '<span class="error">&nbsp;&nbsp;', '</span>'); ?></label><br>
					<input type="text" value="<?php echo $this->session->userdata('ship_city') ?>" id="ship_city" name="ship_city" class="inputtext" style="width:186px;">
				</p>
				<?php 
					$ds = $this->session->userdata('DestinationState'); 
				?>
				<p style="width:60px;float:left;">
					...
					<input type="text" value="<?php echo $this->session->userdata('ship_zipcode') ?>" id="ship_zipcode" name="ship_zipcode" class="inputtext" style="width:60px;" onBlur="javascript:zipcodes(this.value);" >
				</p>
                <?php
